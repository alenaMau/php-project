    ...
    <span class="form_title-span">Добавление телефона</span>
        <form method="post">
            <label>
                ...
                <input type="tel" class="form_input" placeholder="Номер " name="number_telephone">
                <span class="form_title">Помещение</span>
                <select type="text" class="form_input" name="room">
                    <?php foreach($rooms as $room): ?>
                        <option value="<?= $room->id ?>"><?= $room->name ?></option>
                    <?php endforeach; ?>
                </select>
                <span class="form_title">Подразделение</span>
                <select type="text" class="form_input" name="subdivision">
